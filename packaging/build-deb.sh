...
Priority: optional
Architecture: all
Depends: python3, python3-tk, python3-psutil, python3-requests, python3-dbus, python3-pil, python3-xlib, playerctl
...
Description: Desktop system monitor widget
 ...
 network, system stats, storage, and Dopamine music metadata.
EOF
